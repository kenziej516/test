...
public class AccountTest {
	...
	public static void main(String[] args) {
		...
		testMergeAccountSuccessful();
		testMergeAccountUnsuccessful();
	...
	private static void testMultipleDeposits() {
		System.out.println("-->testMultpileDeposits()");
		Account a1 = new Account(1000.0);
		a1.deposit(500.0);
		a1.deposit(300.0);
	...
	private static void testMergeAccountSuccessful(){
	...
	private static void testMergeAccountUnsuccessful(){
		System.out.println("-->testMergeAccountUnsuccessful()");
		Account a1 = new Account("Shay", 1000.0);
